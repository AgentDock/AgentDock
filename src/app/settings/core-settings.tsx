...
function CoreSettingsComponent({ settings, onByokChange, onDebugModeChange }: CoreSettingsProps) {
  return (
    <Card>
      <div className="p-6 space-y-6">
        ...
        <p className="text-sm text-muted-foreground mb-4">Configure core application behavior</p>
              ...
              <div className="rounded-md bg-yellow-500/15 p-4">
                <div className="flex items-center gap-3">
                  ...
                  <p className="text-sm text-yellow-500">
                    Warning: With BYOK mode enabled, agents will fail if you haven&apos;t provided
