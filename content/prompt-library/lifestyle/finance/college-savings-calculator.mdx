...
My preferred savings vehicle is [SAVINGS_VEHICLE:select:529 college savings plan,Coverdell Education Savings Account,custodial account UGMA or UTMA,regular brokerage account,high-yield savings account,not sure which is best for my situation]. For investment returns within that account I expect [EXPECTED_RETURN:select:conservative around 5%,moderate around 7%,aggressive around 9%,not sure so use a moderate estimate].
