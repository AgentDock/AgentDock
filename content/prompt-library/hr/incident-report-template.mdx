...
Incident Classification. State the incident type, severity level, and OSHA recordability. Mark injuries requiring medical treatment beyond first aid, hospitalization, loss of consciousness, or death as OSHA-recordable. Mark near misses and first-aid-only cases as non-recordable.
...
Regulatory and Compliance Notes. Applicable OSHA reporting requirements including Form 300, Form 301, workers compensation deadlines, and filing timeframes based on the incident type and severity.
