  ...
  const isActive = (itemPath: string, itemName?: string): boolean => {
    ...
    if (
      ...
      if (!itemPath.startsWith('/agents/')) {
        ...
        return (
          pathSegments.length === itemSegments.length || pathSegments.length > itemSegments.length
        );
      }
      return true;
    }
      ...
      <div className="flex-1 overflow-y-auto py-4">
        <div className="space-y-6">
          ...
          <div className="px-4">
            ...
            <nav className="flex flex-col gap-1">{coreNavigationItems.map(renderItem)}</nav>
          </div>
          ...
          <div className="px-4">
            ...
            <nav className="flex flex-col gap-1">{additionalNavigationItems.map(renderItem)}</nav>
          </div>
        </div>
      </div>
    </div>
