...
This guide explains how custom node contributions are integrated into AgentDock. This is a crucial aspect of our architecture that ensures stability and maintainability.

## Core Principles

### 1. Simplified Architecture

- Contributors creating custom nodes work **exclusively** within the `src/nodes/` directory
- Each node follows the Vercel AI SDK pattern for tools
...
3. **Create a new folder** within `src/nodes/` for their custom node
   - Example: `src/nodes/my-awesome-node/`
