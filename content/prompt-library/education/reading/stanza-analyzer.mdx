...
description: "Paste any poem and get its stanzas broken out and counted, each one named by the correct term from couplet through octave, the overall pattern stated as regular or shifting, and a clear read on whether each stanza holds one closed thought or lets the meaning run through the break into the next."
slug: "education/reading/stanza-analyzer"
category: "education"
tags: ["stanza", "stanza examples", "types of stanzas", "poetry analysis", "education"]
