    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[525px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Details about the current chat session, including ID, message count, and cumulative
            token usage.
          </DialogDescription>
        </DialogHeader>
        <div className="mt-4 space-y-3">
          ...
          <div>
            ...
            <div className="font-mono text-sm bg-muted p-2 rounded">{messagesCount}</div>
          </div>
            ...
            {!isLoading && !error && sessionData?.cumulativeTokenUsage && (
              <div className="font-mono text-sm bg-muted p-2 rounded space-y-1">
                ...
                <div className="font-semibold">
                  Total Tokens: {sessionData.cumulativeTokenUsage.totalTokens}
                </div>
              </div>
            )}
            {!isLoading && !error && !sessionData?.cumulativeTokenUsage && (
