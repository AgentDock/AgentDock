...
description: "Paste a story or name a well-known work and map it onto the plot diagram, all six stages from exposition to resolution explained with the key events at each point and never a plot detail your text does not contain."
slug: "education/reading/plot-diagram-generator"
category: "education"
tags: ["plot diagram", "Freytag's pyramid", "story structure", "plot elements", "education"]
