...
export interface ChatContainerProps {
  ...
  onStateUpdate?: (state: { messagesCount?: number; orchestration?: OrchestrationState }) => void;
...
const ChatContainer = React.forwardRef<{ handleReset: () => Promise<void> }, ChatContainerProps>(
  ({ className, agentId = 'default', header, onStateUpdate, onChatTurnComplete }, ref) => {
    ...
    if (initError) {
      ...
      return (
        <ChatError error={initError} onRetry={() => window.location.reload()} isOverlay={false} />
      );
    }
