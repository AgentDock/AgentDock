...
description: "Paste any sentence or passage and identify the types of sentences it uses, simple, compound, complex, or compound-complex by structure, and declarative, interrogative, imperative, or exclamatory by purpose, with the exact clauses and punctuation that prove each label."
slug: "education/reading/sentence-types-identifier"
category: "education"
tags: ["types of sentences", "sentence types", "four types of sentences", "sentence structure", "grammar"]
