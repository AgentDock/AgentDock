...
After the base case, build the risk scenario by adjusting the relevant inputs and showing cash balances side by side with the base case. Highlight any periods where the risk scenario produces a negative balance or falls below a minimum operating reserve of two weeks of fixed costs.
