...
I am selling a residential property and need to create a complete seller disclosure form that covers every material fact a buyer should know before making an offer. The property is a [PROPERTY_TYPE:select:single-family home,townhouse,condominium,duplex,multi-family,manufactured home,historic home] located in [STATE] and was built in [YEAR_BUILT:number:1900-2026]. The home has approximately [SQUARE_FEET:number:400-15000] square feet of living space with [BEDROOMS:number:1-10] bedrooms and [BATHROOMS:number:1-8] bathrooms. The lot size is approximately [LOT_SIZE?].
