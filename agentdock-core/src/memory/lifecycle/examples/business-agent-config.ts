  ...
  decayConfig: {
    ...
    rules: [
      // Rule 1: Daily metrics decay quickly (keep data fresh)
      {
        ...
        condition: "keywords.includes('daily') || keywords.includes('hourly') || keywords.includes('real-time')",
        decayRate: 0.3, // 30% decay per day - keeps data current
        minImportance: 0.1,
        neverDecay: false,
        enabled: true,
        description: 'Daily metrics lose relevance quickly, decay fast to maintain current view'
      },
      ...
      // Rule 2: Strategic decisions preserve longer
      {
        ...
        condition: "keywords.includes('strategy') || keywords.includes('decision') || keywords.includes('roadmap')",
      ...
      // Rule 3: Client and customer information preserved
      {
        ...
        condition: "keywords.includes('client') || keywords.includes('customer') || keywords.includes('relationship')",
      ...
      // Rule 4: Financial data decays based on time sensitivity
      {
        ...
        condition: "keywords.includes('revenue') || keywords.includes('cost') || keywords.includes('budget')",
        decayRate: 0.15, // 15% per day - moderately fast
        minImportance: 0.4,
        neverDecay: false,
        enabled: true,
        description: 'Financial metrics need regular updates, decay moderately fast'
      },
      ...
      // Rule 5: Competitive intelligence preserved longer
      {
        ...
        condition: "keywords.includes('competitor') || keywords.includes('market') || keywords.includes('analysis')",
      ...
      // Rule 6: Temporary reports and drafts decay quickly
      {
        ...
        condition: "keywords.includes('draft') || keywords.includes('temp') || keywords.includes('scratch')",
    ...
    customPromotionRules: [
      {
        ...
        condition: "keywords.includes('kpi') || keywords.includes('metric') && accessCount > 5",
        fromType: 'episodic',
        toType: 'semantic',
        enabled: true
      },
      ...
      rules: [
        {
          ...
          condition: "keywords.includes('issue') || keywords.includes('complaint') || keywords.includes('ticket')",
          decayRate: 0.05,
          minImportance: 0.6,
          neverDecay: false,
          enabled: true,
